...
> 用户已拍板选择方向二（strategy 下多 route 按 session 分配），具体方案见 [[tools/model_proxy/docs/designs/2026-07-28-session-route-dispatch-design.md]]。本文档原始结论（"不建议做/优先方向一"）不再有效，仅保留调研数据供参考。
